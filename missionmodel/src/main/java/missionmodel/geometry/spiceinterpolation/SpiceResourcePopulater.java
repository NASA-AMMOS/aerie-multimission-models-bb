...
public class SpiceResourcePopulater {
  ...
  public SpiceResourcePopulater(GenericGeometryCalculator geoCalc, AbsoluteClock absoluteClock, Window[] dataGaps, Duration paddingAroundDataGaps, String geomPath) {
    Bodies bodiesObj = new Bodies(geomPath);
...
//<<<<<<< HEAD:src/main/java/missionmodel/geometry/spiceinterpolation/SpiceResourcePopulater.java
...
//
//=======
//>>>>>>> main:missionmodel/src/main/java/missionmodel/geometry/spiceinterpolation/SpiceResourcePopulater.java
