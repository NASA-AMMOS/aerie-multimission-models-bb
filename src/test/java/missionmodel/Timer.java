 ...
 * each thread.
 * <p>
 *   Here is a common usage example where stats are logged for two parts of a function and a surrounding part:
 *   <pre>
 *     void mainFunc() {
 *       Timer timerMain = new Timer("main", false);
 *       . . .
 *       Timer timer1 = new Timer("part1", false);
 *       . . .
 *       timer1.stop(false)
 *       Timer timer2 = new Timer("part2", false);
 *       . . .
 *       timer2.stop(false)
 *       . . .
 *       timerMain.stop(false)
 *       . . .
 *       Timer.logStats();
 *     }
 *   </pre>
