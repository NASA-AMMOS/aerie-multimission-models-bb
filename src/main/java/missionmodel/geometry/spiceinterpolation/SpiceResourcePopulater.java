...
//        new BodyGeometryGenerator(
//          calculationPeriod.getStart(), body.getName(),
//          calculationPeriod.getThreshold(), calculationPeriod.getMinTimeStep(), calculationPeriod.getMaxTimeStep(),
//          "", geoCalc, bodies);
//      }
//    }
  }
